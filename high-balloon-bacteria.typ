...
== Applications
As discussed in the #link(<background>)[background], high-altitude balloon experimentation carries great potential for studying the possible effects of extraterrestrial terrain, especially Mars, on various keystone species required for sustaining human life. Experiments such as these provide insight on life's challenges and possible adaptations to extreme conditions, such as those experienced in deep space. Further experimentation can investigate how other important species react to such conditions; including not only radiation, but also factors such as temperature. Conclusions drawn from these experiments can inform both further research and decisions on spacefaring missions.
